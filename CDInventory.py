...
class DataProcessor:
    ...
    def add_row():
        ...
        intID, strTitle, strArtist to a dictionary row,
...
class FileProcessor:
    ...
    def read_file(file_name, table):
        """Function to manage data ingestion from .dat file to a list of dictionaries.
        Reads the binary data from file identified by file_name into a 2D table.
        Args:
            file_name (string): name of file used to read the data from
            table (list of dict): 2D list of dicts which holds data while it processes.
...
class IO:
    ...
    @staticmethod
    def user_input():
        """function to get user data for album id, title, and arist.
        Returns
    ...
    # 3.3 process add a CD
        ...
        # 3.3.2 Add item to the table
            try:
                ...
                print('\nError: Only enter number for ID!\n')
        IO.show_inventory(lstTbl)
        continue  # start loop back at top.
    ...
    # 3.5 process delete a CD
        ...
        while True:
            try:
                ...
                print('ID to delete must be a number!\n')
